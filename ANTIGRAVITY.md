...
- [ ] **Phase 3: RPG風ガイドサイト化 & ビジュアル強化**
    - **トップページ**: 「魔法の世界」への入り口。できることを直感的に見せる。
    - **設定ガイドページ**: 「冒険の準備（インストール）」を解説する別ページを作成。
    - **ビジュアル**: RPG風の魔法使いやイラストを生成して追加する。
    - **ターゲット体験**: 小学6年生が一人でセットアップを完了し、「作りたい！」と思えるようにする。
